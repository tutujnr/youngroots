...
export default function NotFound() {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '80px 20px' }}>
      ...
      <button onClick={() => navigate('/')} style={{ padding: '12px 24px', background: '#1D9E75', color: '#fff', border: 'none', borderRadius: 10, fontFamily: 'DM Sans, sans-serif', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
        Go Home
      </button>
    </div>
  );
